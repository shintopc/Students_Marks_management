...
import 'package:package_info_plus/package_info_plus.dart' as div;
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            // Version Info
            FutureBuilder<div.PackageInfo>(
              future: div.PackageInfo.fromPlatform(),
  ...
  Widget _buildHelpTab() {
    return Padding(
      ...
      child: ListView(
        children: const [
          ExpansionTile(
            title: Text('1. Getting Started & School Profile'),
            children: [
              Padding(
                padding: EdgeInsets.all(16.0),
                child: Text(
                  'Navigate to Settings > School Profile to set up your institution details.\n\n'
                  '- School Name: Appears on reports and invoices.\n'
                  '- Address: Displayed on printed documents.\n'
                  '- Logo: Upload your school logo to brand your documents.\n'
                  '- Academic Year: Set the current operational year.',
                ),
              ),
            ],
          ),
          ExpansionTile(
            title: Text('2. Academic Structure'),
            children: [
              Padding(
                padding: EdgeInsets.all(16.0),
                child: Text(
                  'Before adding students, set up your academic structure in Settings > Academic.\n\n'
                  '- Classes: Define the classes (grades) in your school (e.g., "10", "12").\n'
                  '- Divisions: Add divisions for each class (e.g., "A", "B").\n'
                  '- Subjects: List all subjects taught.\n'
                  '- Terms: Define exam terms (e.g., "First Term", "Final").',
                ),
              ),
            ],
          ),
          ExpansionTile(
            title: Text('3. Managing Students'),
            children: [
              Padding(
                padding: EdgeInsets.all(16.0),
                child: Text(
                  'Go to the "Students" tab to manage student records.\n\n'
                  '- Add Student: Click the + button. Fill in details and assign a class/division.\n'
                  '- Edit/Delete: Use the buttons on the student card.\n'
                  '- Search: Use the search bar to find students by name or roll number.',
                ),
              ),
            ],
          ),
          ExpansionTile(
            title: Text('4. Grading & Marks'),
            children: [
              Padding(
                padding: EdgeInsets.all(16.0),
                child: Text(
                  'The "Marks" tab is the core of the evaluation system.\n\n'
                  '- Entry: Select Class, Division, Subject, and Term to enter marks.\n'
                  '- Grading Rules: Configure grade ranges (e.g., 90-100 = A+) in Settings > Grading Rules.\n'
                  '- Auto-Calculation: The app automatically calculates grades and GPAs based on your rules.',
                ),
              ),
            ],
          ),
          ExpansionTile(
            title: Text('5. Reports & Analysis'),
            children: [
              Padding(
                padding: EdgeInsets.all(16.0),
                child: Text(
                  'Generate comprehensive reports from the "Reports" tab.\n\n'
                  '- Class Reports: View performance summary for a whole class.\n'
                  '- Individual Reports: Generate detailed progress reports for specific students.\n'
                  '- Analysis: View charts and trends in the Dashboard.',
                ),
              ),
            ],
          ),
          ExpansionTile(
            title: Text('6. Maintenance & Backup'),
            children: [
              Padding(
                padding: EdgeInsets.all(16.0),
                child: Text(
                  'Use Settings > Maintenance to keep your data safe.\n\n'
                  '- Backup: Regularly save a copy of your database.\n'
                  '- Restore: Recover data from a previous backup file.\n'
                  '- Factory Reset: Wipes all academic data (students, marks) but keeps admin settings.',
                ),
              ),
            ],
          ),
